<template>
  <div>
    ...
    <h1 class="page-title">
      Management - <span class="fw-semi-bold">Mesh Channels</span>
    </h1>
...
export default {
  ...
  mounted() {
    ...
    console.log('getChannels', this.items);
  },
  methods: {
    ...mapGetters({ getItems: 'channels/getItems', getHeaders: 'channels/getHeaders' }),
    ...mapActions({ fetchItems: 'channels/fetchItems' }),
    create() {
      // TODO implement
    },
    deleteSelected() {
